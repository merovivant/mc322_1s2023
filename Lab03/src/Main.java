...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        ClientePJ cliente04 = new ClientePJ("Empresa de Tecnologia XYZ Ltda", "Rua das Acácias, 789", listaVeiculos02, "75.525.966/0001-20", LocalDate.of(1995, 10, 15));
        ClientePJ cliente05 = new ClientePJ("Indústria de Alimentos ABC S.A.", "Avenida das Oliveiras, 456", listaVeiculos03, "88.215.509/0001-08", LocalDate.of(1980, 8, 22));
    ...
    public static void GerarMenu(Seguradora seguradora){
        ...
        System.out.println("Bem vindo ao Menu da Seguradora SafeCar");
        System.out.println("___________________________________________");
        ...
        if(opcao == 2){
            ...
            System.out.print("Encontrei o(s) seguinte(s) sinistro(s):\n");
            ...
            System.out.print("[1] Pessoas Físicas\n");
            System.out.print("[2] Pessoas Jurídicas\n");
            System.out.print("___________________________________________\n");
            opcao = scanner.nextInt();
            System.out.print("\033[H\033[2J");
            System.out.print("___________________________________________\n");
            System.out.print("Encontrei o(s) seguinte(s) cliente(s):\n");
            seguradora.ListarClientes(""+opcao);
            System.out.print("___________________________________________");
        }
        scanner.close();
        //System.out.print("\033[H\033[2J");
